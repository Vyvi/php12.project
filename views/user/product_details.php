...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="public/images/<?= $row['ANH_SP'] ?>" alt="<?= $row['TEN_SP'] ?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><?= number_format($row['GIA_BAN']) ?> VNĐ</span></label>
					<div class="controls">
					<input type="number" class="span1" placeholder="Qty."/>
					  <a type="submit" href="index.php?mod=sale_user&act=addcart&MA_SP=<?= $row['MA_SP'] ?>" class="btn btn-large btn-primary pull-right"> Add to cart <i class=" icon-shopping-cart"></i></a>
					</div>
				  </div>
				</form>
