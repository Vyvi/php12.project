...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal" action="index.php?mod=sale_user&act=send" method="POST" >
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large btn-success" type="submit" value="Gửi mail" />
			</div>
		</div>		
	</form>
</div>
