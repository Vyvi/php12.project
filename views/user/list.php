...
<head>
    ...
    <link href="views/user/css/prettyPhoto.css" rel="stylesheet">
    <link href="views/user/css/price-range.css" rel="stylesheet">
    <link href="views/user/css/animate.css" rel="stylesheet">
	<link href="views/user/css/main.css" rel="stylesheet">
	<link href="views/user/css/responsive.css" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="js/html5shiv.js"></script>
    <script src="js/respond.min.js"></script>
    <![endif]-->       
    <link rel="shortcut icon" href="views/user/images/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="views/user/images/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="views/user/images/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="views/user/images/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="views/user/images/ico/apple-touch-icon-57-precomposed.png">
...
<body>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="views/user/images/home/shipping.jpg" alt="" />
						</div><!--/shipping-->
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="views/user/images/home/iframe1.png" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="views/user/images/home/iframe2.png" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="views/user/images/home/iframe3.png" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="views/user/images/home/iframe4.png" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
    ...
    <script src="views/user/js/jquery.js"></script>
	<script src="views/user/js/bootstrap.min.js"></script>
	<script src="views/user/js/jquery.scrollUp.min.js"></script>
	<script src="views/user/js/price-range.js"></script>
    <script src="views/user/js/jquery.prettyPhoto.js"></script>
